  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-white">
      ...
      <div className="text-center mt-16">
        <h2 className="text-xl mb-4 text-gray-200">Single Player</h2>
        <h2 className="text-3xl font-bold mb-8 text-gray-300">Select Difficulty</h2>
        <div className="flex space-x-4 mb-4">
          <button
            onClick={() => handleSelectDifficulty('Easy')}
            className={`py-3 px-8 rounded-lg shadow-lg font-semibold transition-all ${
              selectedDifficulty === 'Easy' ? 'border-2 border-black text-black' : 'bg-yellow-400 text-black hover:scale-105 hover:border hover:border-black'
            }`}
          >
            Easy
          </button>
          <button
            ...
            className={`py-3 px-8 rounded-lg shadow-lg font-semibold transition-all ${
              selectedDifficulty === 'Medium' ? 'border-2 border-black text-black' : 'bg-yellow-400 text-black hover:scale-105 hover:border hover:border-black'
            }`}
          >
            Medium
          </button>
          <button
            ...
            className={`py-3 px-8 rounded-lg shadow-lg font-semibold transition-all ${
              selectedDifficulty === 'Hard' ? 'border-2 border-black text-black' : 'bg-yellow-400 text-black hover:scale-105 hover:border hover:border-black'
            }`}
          >
            Hard
          </button>
